      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.numpy.lib._stride_tricks_impl.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.numpy.lib._stride_tricks_impl.source.html#l548">
                  <tt><i>548</i>                               <span class="k">for</span> <span class="n">array</span> <span class="ow">in</span> <span class="n">args</span><span class="p">]</span></tt>
               </a>
            </li>
            </ul>
         </li>
